...
CREATE TABLE `student_ratings` (
  `id_stud_rating` int NOT NULL,
  `number` float NOT NULL,
  `comment` varchar(45) NOT NULL,
  `stud_id` int NOT NULL,
  PRIMARY KEY (`id_stud_rating`),
  UNIQUE KEY `id_rating_UNIQUE` (`id_stud_rating`)
...
INSERT INTO `student_ratings` VALUES (0,3,'He\'s ok.',0),(1,4,'Good worker.',0),(2,5,'I love him!',0),(3,3,'test',0);
