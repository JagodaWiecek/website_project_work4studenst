...
CREATE TABLE `mailbox_employer` (
  ...
  `mess_type` enum('application','acceptation','contactStudent') NOT NULL,
...
INSERT INTO `mailbox_employer` VALUES (1,'0','3','application'),(2,'0','7','acceptation'),(3,'0','11','contactStudent'),(4,'0','3','contactStudent');
