...
CREATE TABLE `mailbox_student` (
  ...
  `mess_type` enum('newOffer','accepted','contactEmployer') NOT NULL,
...
INSERT INTO `mailbox_student` VALUES (1,'15','0','newOffer'),(2,'19','0','accepted'),(3,'22','0','contactEmployer'),(4,'3','0','accepted');
